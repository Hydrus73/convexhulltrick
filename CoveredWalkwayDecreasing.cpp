/**
 * This solution to the Covered Walkway problem uses my implementation of the decreasing slope convex hull trick.
 *
...
int main() {
    ...
    ConvexHullTrick::DecreasingOrder convex_hull_trick;
