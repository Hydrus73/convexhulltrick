/**
 * This solution to the Avoiding Airports problem uses my implementation of the dynamic slope convex hull trick.
 *
...
int main() {
    ...
    std::vector<ConvexHullTrick::DynamicOrder> chts(countries);
